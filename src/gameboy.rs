...
impl Gameboy {
    ...
    fn render_tiles(&mut self) {
        ...
        for pixel in 0..WIDTH {
            ...
            let y: u32 = (finally as u32).wrapping_mul(WIDTH as u32).wrapping_mul(4);
            let x: u32 = (pixel as u32).wrapping_mul(4);
            ...
            self.screen_data[xy.wrapping_add(3) as usize] = 0;
        }
    }
            ...
            if (scanline >= (y_pos as i32)) && (scanline < ((y_pos as i32).wrapping_add(y_size))) {
                ...
                for tile_pixel in (0u8..=7).rev() {
                    ...
                    if self.scanline_bg[pixel as usize] || priority {
                        let y: i64 = (scanline as i64).wrapping_mul(WIDTH as i64).wrapping_mul(4);
                        let x: i64 = (pixel as i64).wrapping_mul(4);
