...
pub extern "C" fn retro_get_system_info(info: *mut retro_system_info) {
    let retro_system_info_ref = unsafe { info.as_mut() }.expect("Invalid info:retro_system_info");
    ...
    let valid_extensions = CString::new("").expect("Cstring::new empty failed");
    ...
    retro_system_info_ref.need_fullpath = true;
...
pub extern "C" fn retro_get_system_av_info(info: *mut retro_system_av_info) {
    let retro_system_av_info_ref = unsafe { info.as_mut() }.expect("Invalid info:retro_system_av_info");
...
#[no_mangle]
pub extern "C" fn retro_load_game(_game: *const retro_game_info) -> bool { false }

#[no_mangle]
pub extern "C" fn retro_load_game_special(_game_type: ::std::os::raw::c_uint, _info: *const retro_game_info, _num_info: size_t,) -> bool { false }
