...
use psp2_sys::display::sceDisplaySetFrameBuf;
use psp2_sys::display::SceDisplayFrameBuf;
use psp2_sys::display::SceDisplaySetBufSync::SCE_DISPLAY_SETBUF_NEXTFRAME;
